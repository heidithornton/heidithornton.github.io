...
# Login
token <- ofCloudGetToken(sRegion = "APAC", sName = "xxx", sPwd = "xxx",
                         sClientID = "xxx", 
                         sClientSecret = "xxx")
...
knitr::include_graphics('Images/sparklinetable.png')
...
# Login
token <- ofCloudGetToken(sRegion = "APAC", sName = "xx", sPwd = "xx",
                         sClientID = "xx", 
                         sClientSecret = "xxX")
...
--
```{r power bi report 2, echo=FALSE, fig.align='center', out.width='60%'}
library(pdftools)
...
knitr::include_graphics("Images/Int Slope.png")
...
.footnote[
**References** <br>
Delaney et al. (2017). Modelling the decrement in running intensity within professional soccer players <br>
Duthie et al. (2018). Running intensities in elite youth soccer by age
]
---
...
```{r power bi rules, echo = FALSE, out.width='90%'}
knitr::include_graphics("Images/Power BI formatting rules.png")
...
.pull-right[
`r emo::ji("chart")` Or select other options such as data bars, icons, font colour etc


```{r power bi ticks, echo = FALSE, out.width='110%'}
knitr::include_graphics("Images/Ticks.png")
